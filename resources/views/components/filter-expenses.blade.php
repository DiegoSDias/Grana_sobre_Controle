    ...
    <div class="flex flex-wrap gap-3 items-end">
        ...
        <div class="w-44">
            ...
            <select name="expense_category"
                class="w-full border border-slate-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors">
        ...
        {{-- Método de Pagamento --}}
        <div class="w-40">
            <label class="block text-xs font-medium text-slate-600 mb-1.5">Pagamento</label>
        ...
        {{-- Parcelado --}}
        <div class="w-32">
            <label class="block text-xs font-medium text-slate-600 mb-1.5">Parcelado</label>
